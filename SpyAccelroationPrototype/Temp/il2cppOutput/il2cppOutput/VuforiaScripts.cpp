...
IL_0017:
	...
	{
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_4 = __this->get_mLastRecoModelTarget_4();
		IL2CPP_RUNTIME_CLASS_INIT(Object_tAE11E5E46CD5C37C9F3E8950C00CD8B45666A2D0_il2cpp_TypeInfo_var);
...
IL_0037:
	...
	{
		bool L_10 = __this->get_StopSearchWhileTracking_11();
		if (!L_10)
		{
			goto IL_005e;
		}
	...
	{
		float L_11 = V_0;
		G_B11_0 = ((((float)L_11) > ((float)(0.5f)))? 1 : 0);
		goto IL_005f;
	}
...
IL_005f:
	...
	}
	{
		...
		__this->set_mLastStatusCheckTime_6(L_13);
		// if (mSearching)
		bool L_14 = __this->get_mSearching_5();
		V_4 = L_14;
		bool L_15 = V_4;
		if (!L_15)
		{
	...
	}
	{
		...
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_16 = __this->get_mLastRecoModelTarget_4();
		bool L_17 = DefaultModelRecoEventHandler_IsModelTrackedInView_m484B3B06B82A9C624B57993066A8501F09756D5C(__this, L_16, /*hidden argument*/NULL);
		V_5 = L_17;
		bool L_18 = V_5;
		if (!L_18)
		{
	...
	}
	{
		...
		ModelRecoBehaviour_t136409F3AECD7AEB24CC39E5CA3A50A4CAAF2291 * L_19 = __this->get_mModelRecoBehaviour_7();
		NullCheck(L_19);
		ModelRecoBehaviour_set_ModelRecoEnabled_m7F477AE80EC465F28F1880332B3E1108E494AB73(L_19, (bool)0, /*hidden argument*/NULL);
		// mSearching = false;
...
IL_00a7:
	{
		// if (!IsModelTrackedInView(mLastRecoModelTarget))
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_20 = __this->get_mLastRecoModelTarget_4();
		bool L_21 = DefaultModelRecoEventHandler_IsModelTrackedInView_m484B3B06B82A9C624B57993066A8501F09756D5C(__this, L_20, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_23);
		ModelRecoBehaviour_set_ModelRecoEnabled_m7F477AE80EC465F28F1880332B3E1108E494AB73(L_23, (bool)1, /*hidden argument*/NULL);
		// mSearching = true;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DefaultModelRecoEventHandler_OnNewSearchResult_mD52DF1B20F00770C87F72001D0AE58F9033E251D (DefaultModelRecoEventHandler_tD8D52485390B4887E690E2CE623D20236D7E82CA * __this, TargetSearchResult_tC958489A5AB66221259FCDFD35F79CA426DAC6F5 * ___searchResult0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_8 = V_1;
		NullCheck(L_8);
...
IL_0039:
	...
	}
	{
		...
		TargetSearchResult_tC958489A5AB66221259FCDFD35F79CA426DAC6F5 * L_13 = ___searchResult0;
		NullCheck(L_13);
		String_t* L_14 = L_13->get_TargetName_0();
		String_t* L_15 = String_Concat_mB78D0094592718DA6D5DB6C712A9C225631666BE(_stringLiteral46577BB1949E336EAF7CF1139C900C4D692F7EE5, L_14, /*hidden argument*/NULL);
...
IL_0060:
	{
		...
		TargetFinder_t2AFA3E4A66C461FA522FE35048DB093003A7B1AC * L_17 = __this->get_mTargetFinder_8();
		TargetSearchResult_tC958489A5AB66221259FCDFD35F79CA426DAC6F5 * L_18 = ___searchResult0;
		GameObject_tBD1244AD56B4E59AAD76E5E7C9282EC5CE434F0F * L_19 = V_0;
		NullCheck(L_17);
		TrackableBehaviour_t579D75AAFEF7B2D69F4B68931D5A58074E80A7E4 * L_20 = TargetFinder_EnableTracking_m68B520DCBE39156A36CF8E726FF1D62F978160E9(L_17, L_18, L_19, /*hidden argument*/NULL);
		V_2 = ((ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 *)IsInstClass((RuntimeObject*)L_20, ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0_il2cpp_TypeInfo_var));
		// if (mtb)
	...
	}
	{
		...
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_24 = V_2;
		__this->set_mLastRecoModelTarget_4(L_24);
		// if (StopSearchWhenModelFound)
		bool L_25 = __this->get_StopSearchWhenModelFound_10();
		V_6 = L_25;
		bool L_26 = V_6;
		if (!L_26)
		{
	...
	{
		// mModelRecoBehaviour.ModelRecoEnabled = false;
		ModelRecoBehaviour_t136409F3AECD7AEB24CC39E5CA3A50A4CAAF2291 * L_27 = __this->get_mModelRecoBehaviour_7();
		NullCheck(L_27);
		ModelRecoBehaviour_set_ModelRecoEnabled_m7F477AE80EC465F28F1880332B3E1108E494AB73(L_27, (bool)0, /*hidden argument*/NULL);
	}
...
IL_0014:
	{
		...
		ModelRecoSearchResult_tB293FF5B3A646FF59DE16F2498C74EE958425354 * L_3 = ___searchResult0;
		NullCheck(L_3);
		String_t* L_4 = ((TargetSearchResult_tC958489A5AB66221259FCDFD35F79CA426DAC6F5 *)L_3)->get_TargetName_0();
		V_1 = L_4;
		// foreach (var mt in modelTargetsInScene)
		ModelTargetBehaviourU5BU5D_t7C081ED9446E930306255382D788CD614D99F69B* L_5 = V_0;
		V_4 = L_5;
		V_5 = 0;
		goto IL_005a;
	}
...
IL_0024:
	{
		// foreach (var mt in modelTargetsInScene)
		ModelTargetBehaviourU5BU5D_t7C081ED9446E930306255382D788CD614D99F69B* L_6 = V_4;
		int32_t L_7 = V_5;
		NullCheck(L_6);
		int32_t L_8 = L_7;
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_9 = (L_6)->GetAt(static_cast<il2cpp_array_size_t>(L_8));
		V_6 = L_9;
		// if (mt.TrackableName == targetName)
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_10 = V_6;
		NullCheck(L_10);
	...
	}
	{
		...
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_15 = V_6;
		NullCheck(L_15);
		...
		// return mt;
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_17 = V_6;
		V_3 = L_17;
		goto IL_0066;
	}
...
IL_005a:
	{
		// foreach (var mt in modelTargetsInScene)
		int32_t L_19 = V_5;
		ModelTargetBehaviourU5BU5D_t7C081ED9446E930306255382D788CD614D99F69B* L_20 = V_4;
		NullCheck(L_20);
...
IL_0066:
	{
		// }
		ModelTargetBehaviour_t283F7A0B136589E033A458B5FE0C42F3248CE0B0 * L_21 = V_3;
		return L_21;
	}
}
// System.Void DefaultModelRecoEventHandler::ShowErrorMessageInUI(System.String)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DefaultModelRecoEventHandler_ShowErrorMessageInUI_m6CA52CF0093CC28BC4BCA765B4C701F10C476BEC (DefaultModelRecoEventHandler_tD8D52485390B4887E690E2CE623D20236D7E82CA * __this, String_t* ___text0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Text_tE9317B57477F4B50AA4C16F460DE6F82DAD6D030 * L_3 = __this->get_ModelRecoErrorText_9();
...
{
	{
		...
		__this->set_StopSearchWhenModelFound_10((bool)0);
...
IL_000f:
	{
		...
		OpenSourceUnityCompiledFacade__ctor_mB773D09AA7A4167A5E92922DA08FE6827570DA7C(L_2, /*hidden argument*/NULL);
		...
		UnityCompiledFacade_set_Instance_m1485791E5231923A31D9E6587119599E90DC8760(L_3, /*hidden argument*/NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UnityRenderPipeline_OnBeginCameraRendering_m15CB7AC8363F2493DF182B36D04EACC08258FA71 (UnityRenderPipeline_t62C711062D224A17F999C0F58CDB6F6E641560A4 * __this, ScriptableRenderContext_t7A3C889E3516E8C79C1C0327D33ED9601D163A2B  ___context0, Camera_t48B2B9ECB3CE6108A98BF949A1CECF0FE3421F34 * ___camera1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_2);
		Action_1_Invoke_m2144BC1656C81F7F9B706AA9EC60411F4297170F(L_2, L_3, /*hidden argument*/Action_1_Invoke_m2144BC1656C81F7F9B706AA9EC60411F4297170F_RuntimeMethod_var);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UnityRenderPipeline_OnBeginFrameRendering_mFE0AAA7DA6B16B7ACA3AC9B5F84A6E87266BA491 (UnityRenderPipeline_t62C711062D224A17F999C0F58CDB6F6E641560A4 * __this, ScriptableRenderContext_t7A3C889E3516E8C79C1C0327D33ED9601D163A2B  ___context0, CameraU5BU5D_t2A1957E88FB79357C12B87941970D776D30E90F9* ___cameras1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_2);
		Action_1_Invoke_mA31EEA11FE58129FD616B4B19C332CC256DD9D19(L_2, L_3, /*hidden argument*/Action_1_Invoke_mA31EEA11FE58129FD616B4B19C332CC256DD9D19_RuntimeMethod_var);
	}
